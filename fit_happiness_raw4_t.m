function [fitoutput] = fit_happiness_raw4_t(inx,lb,ub, data,fitoutput_choice)
...
for i=1:length(fitoutput.outcome)
    if fitoutput.choice(i,1)==1
        fitoutput.diff(i,1) = fitoutput.CR(i,1) - fitoutput.EV(i,1);
    elseif fitoutput.choice(i,1)==2
        fitoutput.diff(i,1) = fitoutput.EV(i,1) - fitoutput.CR(i,1);
    end
end
