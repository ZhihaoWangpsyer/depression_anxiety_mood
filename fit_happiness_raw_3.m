function [fitoutput] = fit_happiness_raw_3(inx,lb,ub, data,fitoutput_choice)
...
happypred = weight_CR*CR_mtx*dec + weight_EV*EV_mtx*dec + weight_RPE*RPE_mtx*dec + (weight_t*EV_mtx*dec).*rating_ind' + const;
% for i =1:length(CR)
