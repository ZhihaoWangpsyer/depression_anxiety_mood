function [fitoutput] = fit_happiness_raw_9(inx,lb,ub, data,fitoutput_choice)
...
happypred = weight_CR*CR_mtx*dec + weight_EV*EV_mtx*dec + weight_RPE*RPE_mtx*dec + const;
% for i =1:length(CR)
